...
// // let books = [
// //   { id: 1, title: "Dog", author: "2", genre: "F" },
// //   { id: 2, title: "Cat", author: "8", genre: "F" },
// //   { id: 3, title: "Turtle", author: "13", genre: "M" }
// // ];
// // let myChart;
...
function resetForm() {
  ...
  document.getElementById("add-btn").textContent = "Add"; // Change button text back to "Add"
  isEditing = false;
}
